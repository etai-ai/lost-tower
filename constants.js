...
export const MAPS = [
  { name: "Ancient Labyrinth", points: [
    [0,1],[4,1],[4,4],[1,4],[1,7],[6,7],[6,2],[9,2],[9,7],[9,10],
    [3,10],[3,12],[10,12],[10,9],[14,9],[14,5],[11,5],[11,2],[14,2],[17,2],
    [17,6],[14,6],[14,11],[17,11],[17,8],[19,8],
  ]},
  { name: "The Gauntlet", points: [
    [0,2],[4,2],[4,6],[1,6],[1,10],[6,10],[6,6],[9,6],[9,12],[13,12],
    [13,8],[10,8],[10,4],[14,4],[14,0],[17,0],[17,5],[19,5],
  ]},
  { name: "The Spiral", points: [
    [0,0],[19,0],[19,13],[0,13],[0,3],[17,3],[17,11],[2,11],
    [2,5],[15,5],[15,9],[4,9],[4,7],[13,7],
  ]},
  { name: "The Serpent", points: [
    [0,1],[6,1],[6,5],[2,5],[2,9],[7,9],[7,3],[10,3],
    [10,11],[14,11],[14,5],[11,5],[11,1],[16,1],[16,9],[19,9],
  ]},
  { name: "The Fortress", points: [
    [0,13],[3,13],[3,1],[7,1],[7,6],[4,6],[4,10],[8,10],[8,0],[12,0],
    [12,5],[9,5],[9,9],[13,9],[13,2],[16,2],[16,12],[19,12],
  ]},
  { name: "The Corridor", points: [
    [0,0],[0,5],[3,5],[3,2],[7,2],[7,8],[4,8],[4,12],[9,12],[9,6],
    [12,6],[12,11],[16,11],[16,4],[13,4],[13,1],[19,1],[19,8],[17,8],[17,13],
  ]},
];

export const PATH_POINTS = MAPS[0].points;
